...
<div class="right-content">
    ...
    <p class="content">Total All Reviews  : <span class="highlight"><?php echo count($lists);?></span></p>
            ...
            <td>
               ...
               <ul class="menu">
                   ...
                   <li>
                       ...
                       <a href="/<?php echo DOMAIN; ?>/superadmin/?tab=reviews&target=publish&source=options&review=<?php echo md5($list['sno']); ?>&alpha=<?php if(isset($_GET['alpha'])){echo $_GET['alpha'];} ?>"  title="Publish Company">Publish</a>
                       <?php } else { ?> 
                       <a href="/<?php echo DOMAIN; ?>/superadmin/?tab=reviews&target=unpublish&source=options&review=<?php echo md5($list['sno']); ?>&alpha=<?php if(isset($_GET['alpha'])){echo $_GET['alpha'];} ?>" class="ask unpublish" title="Unpublish Company">Unpublish</a>
                       <span class="unpublish question hide">Are you sure you want to Unpublish this company?</span>
                       <?php } ?>
                   </li>
                   
                   <li>
                       <a href="/<?php echo DOMAIN; ?>/superadmin/?tab=reviews&target=remove&source=options&review=<?php echo md5($list['sno']); ?>&alpha=<?php if(isset($_GET['alpha'])){echo $_GET['alpha'];} ?>" class="ask remove" title="Remove Reviews">Remove</a>
