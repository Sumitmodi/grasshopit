...
<div class="right-content">
    ...
    <?php } else { if(is_array($counts)){ ?> 
        <p class="content">Total number of Reviews: 
        ...
        ?>   
            <li>Name starting with: <?php echo ucfirst($k)?> (
                <a href="<?php echo (int)$v == 0 ? "javascript:void(0)" : '/'.DOMAIN.'/superadmin/?tab=reviews&target=allview&source=tab&alpha='.$k;?>" class="simulator">
