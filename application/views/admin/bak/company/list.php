    ...
    <?php foreach($lists as $list){ ?> 
        <tr>
            ...
            <td>
               ...
               <ul class="menu">
                   <li>
                       <a href="/<?php echo DOMAIN; ?>/superadmin/?tab=company&target=view&source=options&company=<?php echo md5($list['sno']); ?>&alpha=<?php echo $list['name'][0];?>"  title="View Company">View</a>
                   </li>
                   <li>
