...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!--Bootstrap css End-->
        <!--Font Awesome Start-->
        <link href="<?php echo base_url(); ?>assets/public/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all"/>
        <!--Font Awesome End-->
        <!--Default Css Start-->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/public/css/flexslider.css" type="text/css"  />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/public/css/animate.css" type="text/css"  />
        <link href="<?php echo base_url(); ?>assets/public/style.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>assets/public/responsive.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>assets/public/css/fonts.css" rel="stylesheet" type="text/css" />
        <!--<link href="responsive.css" rel="stylesheet" type="text/css" />-->
        <!--Default Css End-->
        <!--jQuery Start-->
        <script src="<?php echo base_url(); ?>assets/public/js/jquery.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/public/js/bootstrap.min.js" type="text/javascript"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/public/js/holder.js"></script>
        <script src="<?php echo base_url(); ?>assets/public/js/jquery.flexslider.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/public/js/waypoints.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/public/js/modernizr.js" type="text/javascript"></script>
            ...
            <div class="custom-container">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <h1 class="logo"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/head-logo.png" alt="logo"></a></h1>
                    </div>
