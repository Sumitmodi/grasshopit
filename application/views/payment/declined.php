        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-sm-8 col-md-8">
                    ...
                    <h3>Click <a href="<?php echo @$_SERVER['HTTP_REFERER'] ?>">here</a> to return to the previous page or <a href="/<?php echo DOMAIN."/login?type=business" ?>">CONTINUE</a> with trial account. </h3>
                </div>
            </div>
        </div>
    </div>
